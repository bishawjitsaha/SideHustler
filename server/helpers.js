...
export const validateTitle = (title) => {
    ...
    if (title.length > 50) throw "Title must be less than 50 characters";
    return title;
}
...
export const validateDescription = (description) => {
    ...
    if (description.length > 250) throw "Description must be less than 250 characters";
    return description;
}
...
export const validateTaskTime = (taskTime) => {
    ...
    if (!REdate.test(taskTime.dateEnd)) throw "Invalid End Date, must be in MM/DD/YYYY format";
...
export const validatePost = (title, description, taskTime, taskPayment, workType) => {
    ...
    return { title, description, taskTime, taskPayment, workType };
}
